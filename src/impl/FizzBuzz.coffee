...
define (require) ->
  EnterpriseGradeFizzBuzzSolutionStrategyFactory =
    require "cs!./factories/EnterpriseGradeFizzBuzzSolutionStrategyFactory"
  ...
  class FizzBuzz
    ...
    #
    # @method fizzbuzz
    # @param {Number} nFizzBuzzUpperLimit the upper limit, inclusive, to which to run the solution.
    #   This is the highest number the FizzBuzz algorithm will count up to before stopping.
    ###
